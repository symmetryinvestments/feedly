...
//	string urlSaveForLater="/v3/tags/user%2F";
	...
	string refreshAccessToken(string refreshToken)
	{
		...
		jsonparam.Authorization="OAuth "~clientToken;
		string ret;
		auto jsonbody=to!string(serializeToJsonString(jsonparam));
		requestHTTP(url,
			(scope req)
	...
	{
		string url="https://"~urlCategories~"/"~category;
		auto jsonparam=Json.emptyObject;
	...
	{
		string url="https://"~urlFeeds~"/"~feedID;
		auto jsonparam=Json.emptyObject;
	...
	{
		string url="https://"~urlFeeds~"/.mget";
	...
	{
		string url="https://"~urlDropbox ~ "/auth";
		auto jsonparam=Json.emptyObject;
	...
	{
		string url="https://"~urlEvernote ~ "/auth";
		auto jsonparam=Json.emptyObject;
	...
	{
		string url="https://"~urlEvernote ~ "/notebooks";
		auto jsonparam=Json.emptyObject;
	...
	string saveArticleEvernote(string notebookName, string[] tags, string entryID, string notebookType, string notebookGUID,
															string comment)
	{
		string url="https://"~urlEvernote ~ "/note";
		auto jsonparam=Json.emptyObject;
	...
	{
		string url="https://"~urlEntries ~ "/"~entryID;
		auto jsonparam=Json.emptyObject;
	...
	{
		string url="https://"~urlEntries ~ "/"~".mget";
	...
	{
		string url="https://"~urlDropbox ~ "/save";
		auto jsonparam=Json.emptyObject;
		jsonparam.entryID=entryID;
	...
	{
		string url="https://"~urlOPML~"/"~streamID~"/contents";
		auto jsonparam=Json.emptyObject;
		jsonparam.Authorization="OAuth "~clientToken;
		if (count>=0)
	...
	{
		string url="https://"~urlPreferences;
		auto jsonparam=Json.emptyObject;
		jsonparam.Authorization="OAuth "~clientToken;
		string ret;
		auto jsonbody=to!string(serializeToJsonString(jsonparam));
	...
	{
		string url="https://"~urlSearchStream ~streamID ~"/contents?query="~query;
		auto jsonparam=Json.emptyObject;
		jsonparam.Authorization="OAuth "~clientToken;
		string ret;
		auto jsonbody=to!string(serializeToJsonString(jsonparam));
	...
	{
		string url="https://"~urlSubscriptions;
		auto jsonparam=Json.emptyObject;
		jsonparam.Authorization="OAuth "~clientToken;
		string ret;
		auto jsonbody=to!string(serializeToJsonString(jsonparam));
	...
	{
		string url="https://"~urlSubscriptions ~"/"~ID;
		auto jsonparam=Json.emptyObject;
		jsonparam.Authorization="OAuth "~clientToken;
...
/*
	...
	{
		string url="https://"~urlSaveForLater~this.clientID~"%2Ftag%2Fglobal.saved";
		auto jsonparam=Json.emptyObject;
		jsonparam.action="markAsSaved";
		jsonparam["type"]="entries";
		jsonparam.Authorization="OAuth "~clientToken;
...
*/
	...
	{
		string url="https://"~urlSearchFeeds;
		auto jsonparam=Json.emptyObject;
	...
	{
		string url="https://"~join(tags,",")~"/"~join(entryIDs,",");
		auto jsonparam=Json.emptyObject;
		jsonparam.Authorization="OAuth "~clientToken;
	...
	{
		string url="https://"~urlTwitterSuggest1;
		auto jsonparam=Json.emptyObject;
		jsonparam.Authorization="OAuth "~clientToken;
		string ret;
	...
	{
		string url="https://"~urlTwitterSuggest2;
		string ret;
	...
	{
		string url="https://"~urlTwitterAuth;
		string ret;
		auto jsonparam=Json.emptyObject;
		jsonparam.Authorization="OAuth "~clientToken;
